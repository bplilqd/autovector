...
class auth_remind_password extends view implements interface_view, interface_auth
{
    public function __construct()
    {
        $this->start_standart_view();
        $this->setting_properties('title', $this->translations->get_message('auth', 'title_remind_password'));
    }
