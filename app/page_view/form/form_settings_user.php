...
class form_settings_user extends form implements interface_form
{
    ...
    private function option_setting_form()
    {
        ...
        if (isset($data['edit_form'])) {
            $edit_form_language = $data['edit_form']['language'];
            $edit_form_user_theme = $data['edit_form']['user_theme'];
            $edit_form_data_bs_theme = $data['edit_form']['data_bs_theme'];
        }
        ...
        if ($data['data_user']) {
            ...
            [data_bs_theme] => dark
            */
            $data_user_language = $data['data_user']['language'];
            $data_user_user_theme = $data['data_user']['user_theme'];
            $data_user_data_bs_theme = $data['data_user']['data_bs_theme'];
        }
        ...
        $user_theme_data = $data['user_theme_data'];
        $language_data = $data['language_data'];
        
        $option_user_theme = $this->set_option_form_select($user_theme_data, $user_theme);;
        $option_language = $this->set_option_form_select($language_data, $language);
